...
@DatabaseChange(
        name = "updateAuditTrigger",
        description = "Update the audit trigger and function for an existing audit table.",
        priority = ChangeMetaData.PRIORITY_DEFAULT)
public class UpdateAuditTriggerChange extends AbstractChange {

    private String tableName;

    @DatabaseChangeProperty(
            description = "The name of the table to base the audit table on.",
